...
class TestDygraphShardingStage2(TestMultipleGpus):
    ...
    def test_dygraph_sharding_stage2_main_grad(self):
        self.run_mnist_2gpu('dygraph_group_sharded_stage2_main_grad.py')

    def test_dygraph_sharding_stage2_offload_main_grad(self):
        self.run_mnist_2gpu('dygraph_group_sharded_stage2_offload_main_grad.py')
